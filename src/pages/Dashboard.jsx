        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="lg:col-span-2">
                    <Card className="h-full border-blue-100 bg-gradient-to-br from-white to-blue-50">
                        ...
                        <div className="space-y-4">
                            <div className="p-3 bg-white rounded-lg border border-blue-100 shadow-sm">
                                <p className="text-gray-700 text-sm"><span className="font-semibold text-blue-600">Traffic Spike:</span> Organic traffic is up 24% this week, primarily driven by the "Summer Collection" blog post.</p>
                            </div>
                            <div className="p-3 bg-white rounded-lg border border-blue-100 shadow-sm">
                                <p className="text-gray-700 text-sm"><span className="font-semibold text-blue-600">Inventory Alert:</span> 3 top-selling items are predicted to go out of stock within 5 days based on current sales velocity.</p>
                            </div>
                            <div className="p-3 bg-white rounded-lg border border-blue-100 shadow-sm">
                                <p className="text-gray-700 text-sm"><span className="font-semibold text-blue-600">Customer Sentiment:</span> Positive sentiment has increased by 12% following the new automated support responses.</p>
                            </div>
                        </div>
                    </Card>
                </div>
                ...
                <div className="lg:col-span-1">
                    <Card title="Top Opportunities" className="h-full">
                        <div className="space-y-4">
                            {[
                                { title: "Recover 12 abandoned carts", value: "$1,240 potential", icon: ShoppingCart, color: "text-orange-600", bg: "bg-orange-50" },
                                { title: "Re-engage dormant users", value: "450 users", icon: Users, color: "text-purple-600", bg: "bg-purple-50" },
                                { title: "Optimize 5 underperforming ads", value: "Save $300/mo", icon: TrendingUp, color: "text-green-600", bg: "bg-green-50" },
                            ].map((item, index) => (
                    ...
                    <Card title="Catalog Health Status">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-gray-900">98% Healthy</h4>
                                    <p className="text-sm text-gray-500">452 products synced</p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-600">Missing Descriptions</span>
                            ...
                            <div className="flex justify-between text-sm mt-3">
                                <span className="text-gray-600">Low Quality Images</span>
                    ...
                    <Card className="bg-red-50 border-red-100">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-red-700 mt-1">2 payment gateways need re-authentication. This may affect checkout.</p>
                                <button className="mt-3 text-sm font-medium text-red-700 hover:text-red-800 underline">Fix Issue</button>
                            </div>
                        </div>
                    </Card>
                </div>
